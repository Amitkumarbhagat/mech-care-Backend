...
<li><a href="#"><i class="fa fa-files-o"></i> Shops</a>
<ul>
<li><a href="create-brand.php">Create Shope</a></li>
<li><a href="manage-brands.php">Manage garage</a></li>
</ul>
</li>

<li><a href="#"><i class="fa fa-sitemap"></i> Shops</a>
					<ul>
						<li><a href="post-avehical.php">Post a shop</a></li>
						<li><a href="manage-vehicles.php">Manage shop</a></li>
					</ul>
				</li>
				<li><a href="manage-bookings.php"><i class="fa fa-users"></i> Manage Booking</a></li>

				<li><a href="testimonials.php"><i class="fa fa-table"></i> Manage request</a></li>
